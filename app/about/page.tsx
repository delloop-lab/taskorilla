...
export default function AboutPage() {
  ...
  const content = language === 'pt' ? {
    ...
    teeTitle: "Meet TEE",
    teeText: "You'll see TEE around the site, our gorilla mascot. Inspired by the strength, reliability, and calm focus of real gorillas, TEE acts as a friendly guide to make your experience warmer and less stressful. No noise, no pressure, just steady support, reflecting how we want Taskorilla to feel.",
