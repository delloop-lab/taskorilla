        ...
        <div className="mb-8">
          <div className="mb-2 flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
            ...
            <div className="flex w-full flex-wrap items-center gap-2 md:w-auto md:flex-nowrap">
              <Link
                href="/helpers"
                className="inline-flex min-h-[42px] flex-1 items-center justify-center gap-2 px-3 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors text-sm font-medium md:flex-none"
              >
                {t('navbar.browseAllHelpers')}
              </Link>
              <button
                onClick={() => setShowFilters(!showFilters)}
                className="flex min-h-[42px] flex-1 items-center justify-center gap-2 px-3 py-2 bg-primary-600 text-white rounded-lg hover:bg-primary-700 transition-colors md:flex-none"
              >
