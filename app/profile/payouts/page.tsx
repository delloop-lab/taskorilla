...
export default function PayoutsPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      {/* Payouts List */}
      {payouts.length === 0 ? (
        <div className="rounded-2xl border border-slate-200 bg-white/95 shadow-sm p-8 text-center">
          <div className="mx-auto mb-4 inline-flex h-12 w-12 items-center justify-center rounded-full border border-primary-200 bg-primary-50 text-primary-700">
